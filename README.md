...
**Current release:** [v1.0.12](https://github.com/srtviperjr/MessageManager/releases/tag/v1.0.12)
...
```bash
gh release create v1.0.12 dist/MessageManager.pkg \
  --title "MessageManager 1.0.12" \
