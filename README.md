...
**Current release:** [v1.0.29](https://github.com/srtviperjr/MessageManager/releases/tag/v1.0.29)
...
```bash
gh release create v1.0.22 dist/MessageManager.pkg \
  --title "MessageManager 1.0.22" \
