...
class FdaProbeSummaryTests(unittest.TestCase):
    def test_recommends_python_over_terminal(self) -> None:
        targets = [
            {"id": "app", "ok": True, "informational": True},
            {"id": "python", "ok": True},
    ...
    def test_does_not_recommend_app_sync_method(self) -> None:
        targets = [
            {"id": "app", "ok": True, "informational": True},
            {"id": "python", "ok": False},
            {"id": "server", "ok": False, "informational": True},
        ...
        self.assertEqual(result["summary"]["recommended"], "terminal")
        self.assertFalse(result["summary"]["clean_path_ready"])
